...
import org.example.zadaniye3.models.LocationDto;
import org.example.zadaniye3.models.Post;
...
public class Main3 {
    public static void main(String[] args) {
        ...
        System.out.println("""
                Решение по заданию 3, В ранее созданном Package под названием models создаем класс с названием
                InRadiusDto, далее копируем в него соответствующий код класса из папки target проекта созданного
