...
import task14_4_1.zadanye2.model.TestObject;
	...
	public static void main(String[] args) {
		System.out.println("""
            Модуль 14. Spring. Задание №4:\s
                Задания:
                2. При помощи фреймворка Spring опираясь на код из урока реализовать возможность
                   получения данных от пользователя в формате JSON, сохранять их
