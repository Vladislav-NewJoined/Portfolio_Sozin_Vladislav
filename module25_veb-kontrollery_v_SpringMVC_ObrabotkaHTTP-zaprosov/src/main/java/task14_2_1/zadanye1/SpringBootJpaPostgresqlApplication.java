	...
	public static void main(String[] args) {
		System.out.println("""
               Модуль 14. Spring. Задание №2:\s
                   Задания:
                   1. Создать контроллер в который при помощи POST метода можно записывать какой - либо объект.
               
                   Решение:
               \s""");

		System.out.println("В рамках решения задания, отправляем через приложение Postman запрос POST такого вида: " +
				"JSON" +
				"{\n" +
				"    \"id\": 1,\n" +
				"    \"name\": \"Example Name\"\n" +
