	...
	public static void main(String[] args) {
		System.out.println("""
               Модуль 14. Spring. Задание №2:\s
                   Задания:
                   2. Реализуйте передачу данного объекта в виде JSON.
               
                   Решение:
               \s""");

		System.out.println(" В коде ниже реализована передача данного объекта в виде JSON. " +
