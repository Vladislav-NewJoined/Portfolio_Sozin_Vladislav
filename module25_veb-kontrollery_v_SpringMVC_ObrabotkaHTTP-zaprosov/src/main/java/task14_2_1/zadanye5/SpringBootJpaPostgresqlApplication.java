	...
	public static void main(String[] args) {
		System.out.println("""
               Модуль 14. Spring. Задание №2:\s
                   Задания:
                   5. При помощи другого метода возвращайте значение которое было получено.
		...
		testObject3.setName("Example Name");

		// Вызов метода для преобразования в регистр, который был до преобразования
		testObject3.getOriginalName();

		// Вывод значения поля name, который был до преобразования
		System.out.println("Значение поля name в регистре, который был до преобразования: " + testObject3.getName());
	}
}
