...
public class PhotoMessageUtils {
    public static List<String> savePhotos(List<File> files, String botToken) throws IOException {
        ...
        for (File file: files) {
            ...
            final String localFileName = "module09_Task10_Telegram_bot_dlya_upravleniya_izobrazheniyami/src/main/java/org/example/images/" + new Date().getTime() + random.nextLong() + ".jpeg";
